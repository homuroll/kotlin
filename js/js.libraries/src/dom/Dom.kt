...
@Deprecated("Use childNodes() function with safe call", ReplaceWith("this?.childNodes()?.asList().orEmpty()"), level = DeprecationLevel.ERROR)
...
@Deprecated("Use getElementsByTagName() instead", ReplaceWith("getElementsByTagName(localName).asList()"), level = DeprecationLevel.ERROR)
...
@Deprecated("Use getElementsByTagName() function with safe call", ReplaceWith("this?.getElementsByTagName(localName)?.asList().orEmpty()"), level = DeprecationLevel.ERROR)
...
@Deprecated("Use getElementsByTagNameNS() function instead", ReplaceWith("this?.getElementsByTagNameNS(namespaceUri, localName)?.asList().orEmpty()"), level = DeprecationLevel.ERROR)
...
/** Returns all the descendant elements given the namespace URI and local element name */
@Deprecated("Use getElementsByTagNameNS() function with safe call", ReplaceWith("this?.getElementsByTagNameNS(namespaceUri, localName)?.asList().orEmpty()"), level = DeprecationLevel.ERROR)
 ...
 * Returns a list containing only [Element] nodes.
 */
@Deprecated("Use filter function instead", ReplaceWith("asList().filter { it.isElement } as List<Element>"), level = DeprecationLevel.ERROR)
