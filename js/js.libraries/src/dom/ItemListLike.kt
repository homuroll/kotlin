...
public external interface ItemListLike<out T> {
    open val length: Int
    fun item(index: Int): T?
}

/**
 * Returns the view of this `ItemListLike<T>` collection as `List<T>`
 */
public fun <T> ItemListLike<T>.asList(): List<T> = object : AbstractList<T>() {
