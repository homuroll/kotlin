...
public external abstract class NodeList : ItemListLike<Node> {
...
public external abstract class HTMLCollection : UnionElementOrHTMLCollection, ItemListLike<Element> {
    override open val length: Int
...
public external abstract class NamedNodeMap : ItemListLike<Attr> {
    override open val length: Int
...
public external abstract class DOMTokenList : ItemListLike<String> {
    override open val length: Int
    open var value: String
...
public external interface DOMRectList : ItemListLike<DOMRect> {
